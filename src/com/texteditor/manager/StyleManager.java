...
public class StyleManager {
	...
	public void deleteCustomStyle(String name) { customStyles.remove(name);}
    
	public Style getStyle(String name) { return customStyles.getOrDefault(name, builtInStyles.get(name));}
	...
	public List<String> getCustomStyleNames() { return new ArrayList<>(customStyles.keySet());}
	...
	public List<String> getAvailableStyleSets() { return new ArrayList<>(STYLE_SETS.keySet());}
